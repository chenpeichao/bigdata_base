...
/**
 * 基于间隔的join
 * 可以实现两个流在第一个流指定时间段和第二个流的关联关系的应用
 * 类似于connect实现支付测试案例--没有报警
 *
 * @author: ceek
 * @create: 2023/3/8 16:40
 */
public class IntervalJoinTest {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Event> clickStream = env.fromElements(
                ...
                new Event("Alice", "./prod?id=300", 14000L),
        ...
        //首先需要分组，得到每一个数据;key相同不会清除数据
        orderStream.keyBy(data -> data.f0)
                .intervalJoin(clickStream.keyBy(data -> data.getName()))
