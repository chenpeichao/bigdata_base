 ...
 *
 * @author: ceek
 * @create: 2022/9/15 15:16
 */
public class BatchWordCountClass {
    public static void main(String[] args) throws Exception {
        ...
        FlatMapOperator<String, Tuple2<String, Long>> wordAndOneTuple = lineDS.flatMap(new myFlatMap());
...
class myFlatMap implements FlatMapFunction<String, Tuple2<String,Long>> {
    @Override
